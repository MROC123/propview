...
ActiveRecord::Schema[7.1].define(version: 2024_05_21_115025) do

# ActiveRecord::Schema[7.1].define(version: 2024_05_21_131615) do
  ...
  create_table "bookmarks", force: :cascade do |t|
    ...
    t.index ["manager_id"], name: "index_bookmarks_on_manager_id"
  ...
  add_foreign_key "bookmarks", "managers"
